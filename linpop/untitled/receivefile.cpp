    ...
    ui(new Ui::receivefile)
{
    ...
    ui->label_2->setText("等待与" + otheruser.name + "连接");
    ip = otheruser.ip;
    qDebug() << ip;
    port = 9988;
    isStart = true;
    ...
    connect(tcpSocket,&QTcpSocket::connected,[=](){
        ui->label_2->setText("连接成功，等待"+otheruser.name+"发送");
    });
    ...
    connect(tcpSocket,&QTcpSocket::readyRead,[=](){
        ...
        if(isStart == true)
        {
            ...
            ui->label_2->setText("发现文件"+fileName);
            receiveSize = 0;
